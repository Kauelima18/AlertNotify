...
const contractABI = require("../artifacts/contracts/Alertnotifychain.sol/Alertnotifychain.json").abi;

program
    .name("alertnotifychain-cli")
    .description("CLI tool for Alertnotifychain smart contract")
    .version("1.0.0");
